...
public class ArtistInfoFragmentPresenter extends BasePresenter<IArtistInfoFragment> {

    private IArtistInfoFragment fragment;

    public ArtistInfoFragmentPresenter(IArtistInfoFragment fragment) {
        attachView(fragment);
    ...
    public void getData(Artist artist){
        ...
        getAlbumDataList(artist);
        getMusicDataList(artist);

    }


    private void getAlbumDataList(Artist artist){

        Observable
                .create((ObservableOnSubscribe<List<Album>>) e -> {

                    List<Album> albumList= Mp3Util.newInstance().getArtistAlbums(artist);
    ...
    private void getMusicDataList(Artist artist){
