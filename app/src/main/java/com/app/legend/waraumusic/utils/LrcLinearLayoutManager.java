...
public class LrcLinearLayoutManager extends LinearLayoutManager{
    ...
    public LrcLinearLayoutManager(Context context) {
        super(context);

        this.contxt=context;
    }

    public LrcLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
    }

    public LrcLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        LinearSmoothScroller linearSmoothScroller =
                new LinearSmoothScroller(recyclerView.getContext()) {
                    ...
                    public PointF computeScrollVectorForPosition(int targetPosition) {
                        return LrcLinearLayoutManager.this
